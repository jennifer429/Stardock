  ...
  */
  boats: [
    ...
    },
    {
      ...
      year:   "1977",
      price:  "$8,000",
      engine: "60 HP Mercury 2-stroke",
      badge:  "For sale",
      hp:     "60 HP Mercury 2-stroke",
      hull:   "Center console",
      extra:  "Galvanized trailer included",
      highlights: [
        "60 HP Mercury 2-stroke — serviced & inspected",
      ...
      blurb:  "A classic 1977 McKee Craft — the legendary “unsinkable” skiff, lovingly restored. 60 HP Mercury two-stroke, hydraulic steering, Bose sound & GPS.",
      desc:   "A true Florida classic. From the 1960s on, McKee Craft earned its nickname — “The Unsinkables” — with a double-hull, full-foam-flotation design that keeps the boat afloat even when swamped, built over a cathedral hull that runs dry and stable in a chop. Decades later they're still prized as tough, safe, seaworthy boats that punch well above their size.\n\nThis 1977 14-footer has been lovingly restored — original, beautifully finished woodwork blended with modern upgrades throughout. Power is a 60 HP Mercury two-stroke outboard, with hydraulic steering, a new Bose sound system, GPS and fishfinder, and professionally rewired electrics. The engine is clean, fully serviced and inspected by a certified outboard technician, with strong compression on every cylinder. Light, unsinkable by design, and easy to launch — a one-of-a-kind first boat, backwater skiff or weekend fishing rig. Comes on a galvanized trailer.",
    },
  ],
